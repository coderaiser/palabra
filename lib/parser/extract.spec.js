...
test('palabra: parser: extract: extractDirectory', (t) => {
    ...
    const expected = [
        'wget -c -nc https://github.com/rizinorg/rizin/releases/download/v0.8.2/rizin-v0.8.2-static-x86_64.tar.xz -O ${XDG_CACHE_HOME:-/tmp}/rizin-v0.8.2-static-x86_64.tar.xz',
        'rm -rf ~/.local/src/rizin',
        'mkdir -p ~/.local/src/rizin',
        'tar xf /tmp/rizin-v0.8.2-static-x86_64.tar.xz -C ~/.local/src/rizin',
        'rm /tmp/rizin-v0.8.2-static-x86_64.tar.xz',
    ];
