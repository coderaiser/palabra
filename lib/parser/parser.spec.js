...
test('palabra: parser', (t) => {
    ...
    const expected = [
        'wget https://flatassembler.net/fasm-1.73.32.tgz -O /tmp/fasm-1.73.32.tgz',
...
test('palabra: parser: couple bin', (t) => {
    ...
    const expected = [
        'wget https://go.dev/dl/go1.21.2.linux-amd64.tar.gz -O /tmp/go1.21.2.linux-amd64.tar.gz',
        'rm -rf ~/.local/src/go',
...
test('palabra: parser: tar.xz', (t) => {
    ...
    const expected = [
        'wget https://github.com/amber-lang/amber/releases/download/0.5.1-alpha/amber-linux-gnu-x86_64.tar.xz -O /tmp/amber-linux-gnu-x86_64.tar.xz',
